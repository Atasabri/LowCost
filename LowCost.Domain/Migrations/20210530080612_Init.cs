        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    User_Id = table.Column<string>(nullable: false),
                    Driver_Id = table.Column<string>(nullable: true),
                    Street = table.Column<string>(nullable: true),
                    Building = table.Column<string>(nullable: true),
                    Floor = table.Column<string>(nullable: true),
                    Apartment = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_AspNetUsers_Driver_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CardExpDate = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PaymentMethods_AspNetUsers_User_Id",
                        column: x => x.User_Id,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(nullable: false),
                    Name_AR = table.Column<string>(nullable: false),
                    MainCategory_Id = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Categories_MainCategories_MainCategory_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderStatuses_Orders_Order_Id",
                        column: x => x.Order_Id,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderStatuses_Statuses_Status_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderDetails_Markets_Market_Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prices_Markets_Market_Id",
                        column: x => x.Market_Id,
                        principalTable: "Markets",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.InsertData(
                table: "Offers",
                columns: new[] { "Id", "Name", "Name_AR" },
                values: new object[] { 1, "Low Cost Offers", "عروض متجرنا" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_MainCategory_Id",
                table: "Categories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderDetails_Market_Id",
                table: "OrderDetails",
                column: "Market_Id");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatuses_Order_Id",
                table: "OrderStatuses",
                column: "Order_Id");

            migrationBuilder.CreateIndex(
                name: "IX_OrderStatuses_Status_Id",
                table: "OrderStatuses",
                column: "Status_Id");
